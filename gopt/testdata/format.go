...
type quxOption int64

func (o quxOption) apply(opts *sampleOptions) { opts.qux = int64(o) }

func WithQux(value int64) SampleOption { return quxOption(value) }

type quuxOption string

func (o quuxOption) apply(opts *sampleOptions) { opts.quux = string(o) }

func WithQuux(value string) SampleOption { return quuxOption(value) }
