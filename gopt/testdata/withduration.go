...
type bazOption time.Duration

func (o bazOption) apply(opts *sampleOptions) { opts.baz = time.Duration(o) }

func WithBaz(value time.Duration) SampleOption { return bazOption(value) }
